        ...
        <div className="sticky top-0 min-h-[100svh] flex flex-col items-center justify-center px-5 py-8 overflow-hidden">
          <div className="w-full max-w-sm mx-auto text-center space-y-4 relative z-10">
            ...
            y: headlineY
              ...
              <h1 className="text-2xl font-bold text-white leading-tight drop-shadow-lg px-2">Descubra novo Brinde da L´oreal Paris.</h1>
            ...
            y: buttonY
              ...
              <Button onClick={onStartQuiz} size="lg" className="w-full bg-white text-[hsl(270_50%_35%)] hover:bg-white/95 shadow-xl font-semibold text-base h-14 rounded-xl">
